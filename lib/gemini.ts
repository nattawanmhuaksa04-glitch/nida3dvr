...
1. คำฟุ่มเฟือย (เออ/อืม/แบบว่า/อ่า/คือ/ประมาณว่า) — /25
...
export function fallbackScore(duration: number, slideCount: number): AIScore {
  ...
  return {
    ...
    strengths: ["สามารถนำเสนอจนจบได้"],
    improvements: ["เพิ่ม microphone permission เพื่อรับการวิเคราะห์เต็มรูปแบบ"],
    overallFeedback: "ไม่สามารถวิเคราะห์เต็มรูปแบบได้เนื่องจากไม่มีข้อมูลเสียง กรุณาอนุญาต microphone permission",
  };
}
