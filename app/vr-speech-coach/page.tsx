            ...
            <div className="px-7 py-5 space-y-4 flex-1">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { icon: <Headset size={15} className="text-brand-600" />, title: "Select items and press Enter VR *", desc: "Select a Presentation and a VR Video background, then click Enter VR." },
